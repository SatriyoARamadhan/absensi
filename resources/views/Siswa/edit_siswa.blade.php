                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
							...
							<div class="form-group"><label class="col-sm-2 control-label text-right"><b>NIS</b></label>
                              <div class="col-sm-10"><input value="{{ $siswa->nis }}" type="text" onkeypress="return Angkasaja(event)" maxlength="8" minlength="8" class="form-control"><br></div>
                            </div>

                            <div class="form-group">
                              <label class="col-sm-2 control-label text-right"><b>Nama</b></label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="nama" value="{{ $siswa->nama }}"><br></div>
                            </div>

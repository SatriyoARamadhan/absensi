          ...
          <div class="col-md-12 nav-wrapper">
            ...
            <ul class="nav navbar-nav search-nav">
                  <li class="dropdown menu-large">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Seputar Wikrama<b class="caret"></b> </a>
                    <ul class="dropdown-menu megamenu row">
                      <li>
                
                        <div class="col-sm-6 col-md-3 sub-megamenu">
                          <div class="col-md-12" style="padding-top:10px;">
                              <h4 style="margin-left:10px;"><b>Social Media</b></h4>
                          </div>
                          <!--
                          <div class="col-sm-7">
                            <ul class="nav">
                              ...
                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> OTKP Wikrama
                                </a>
                              </li>

                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> MMD Wikrama
                                </a>
                              </li>

                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> RPL Wikrama
                                </a>
                              </li>

                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> TKJ Wikrama
                                </a>
                              </li>

                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> BDP Wikrama
                                </a>
                              </li>

                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> TBG Wikrama
                                </a>
                              </li>

                              <li class="ripple">
                                <a class="tree-toggle nav-header">
                                  <span class="fa-angle-right fa right-arrow text-right"></span> HTL Wikrama
                                </a>
                              </li>
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="item active">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#777:#555/text:First slide" alt="First slide" src="asset/img/wikrama1.jpg">
                        </div>
                        <div class="item">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#666:#444/text:Second slide" alt="Second slide" src="asset/img/wikrama3.jpg">
                        </div>
                        <div class="item">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#555:#333/text:Third slide" alt="Third slide" src="asset/img/wikrama4.jpg">
                        </div>
                        <div class="item">
                          <img class="img-responsive" data-src="holder.js/900x500/auto/#555:#333/text:Quad slide" alt="Quad slide" src="asset/img/wikrama6.jpg">
                        </div>
                      </div>
                  ...
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <ul class="nav navbar-nav">
                            <li><a href="{{ url('/OTKP') }}">OTKP</a></li>
                            <li><a href="{{ url('/RPL') }}">RPL</a></li>
                            <li><a href="{{ url('/TKJ') }}">TKJ</a></li>
                            <li><a href="{{ url('/MMD') }}">MMD</a></li>
                            <li><a href="{{ url('/BDP') }}">BDP</a></li>
                            <li><a href="{{ url('/TBG') }}">TBG</a></li>
                            <li><a href="{{ url('/HTL') }}">HTL</a></li>
                          <!--

                    ...
                    <ul class="dropdown-menu megamenu row">
                      <li>
                        ...
                        <div class="col-sm-6 col-md-3 sub-megamenu">
                          ...
                          <div class="col-sm-6">
                            <ul class="nav">
                              <li><a href="#"><span class="fa fa-angle-right"></span> No-Telp</a></li>
                              <li><a href="#"><span class="fa fa-angle-right"></span> Instagram</a></li>
                              <li><a href="#"><span class="fa fa-angle-right"></span> Whats App</a></li>
                              <li><a href="#"><span class="fa fa-angle-right"></span> Youtube</a></li>
                            </ul>
                          </div>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <span class="fa fa-pencil-square"></span> Data Rombel  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> RPL  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> TKJ  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> MMD  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> OTKP  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> BDP  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> TBG  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!-- Kelas Rombel -->
                        <li>
                          <a href=""> HTL  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                        </li>
                        <!--
